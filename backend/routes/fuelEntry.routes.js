...
router.post('/', authorizedRoles('admin'), validate(FuelEntrySchema), createFuelEntry);
router.put('/:id', validateObjectId(), authorizedRoles('admin'), validate(FuelEntrySchema), updateFuelEntry);
